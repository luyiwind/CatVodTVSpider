...
move "%~dp0\spider.jar\dist\dex.jar" "%~dp0\custom_spider_xp.jar"

certUtil -hashfile "%~dp0\custom_spider_xp.jar" MD5 | find /i /v "md5" | find /i /v "certutil" > "%~dp0\custom_spider_xp.jar.md5"
